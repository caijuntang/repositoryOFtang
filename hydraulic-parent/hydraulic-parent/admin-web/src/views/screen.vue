        ...
        <div>
          ...
          <el-row>
            ...
            <el-col :span="6">
              ...
              <!-- 轮播表格部分 -->
              <div class="left_box3">
                <dv-border-box-11 style="padding-top: 10px" title="泵机电压">
            ...
            <el-col :span="12">
              <!-- 视频部分 -->
              <div id="video" style="align-content: center">
                <dv-border-box-7 style="width:45%;height:40%;display:inline-block">
                  <div id="live1" class="videoDiv"></div>
                </dv-border-box-7>
                <dv-border-box-7 style="width:45%;height:40%;display:inline-block;margin-left:20px">
                  <div id="live2" class="videoDiv"></div>
                </dv-border-box-7>
                <dv-border-box-7 style="width:45%;height:40%;display:inline-block;margin-top:20px">
                  <div id="live3" class="videoDiv"></div>
                </dv-border-box-7>
                <dv-border-box-7 style="width:45%;height:40%;display:inline-block;margin-left:20px;margin-top:20px">
            ...
            <el-col :span="6">
              ...
              <div class="right_box3" >
                <dv-border-box-11 style="padding-top: 10px" title="泵机电流">
