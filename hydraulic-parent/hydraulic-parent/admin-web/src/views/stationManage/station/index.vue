<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :show-overflow-tooltip="true" label="泵站名称" width="125px" prop="title" />
      <el-table-column prop="province" label="省份" align="center" width="60px" />
      <el-table-column prop="city" align="center" label="城市" />
      <el-table-column :show-overflow-tooltip="true" prop="pumpCount" label="泵机数量" />
